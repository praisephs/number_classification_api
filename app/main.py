...
def classify_number(number: int = Query(..., description="An integer to classify")):
    ...
    return JSONResponse(content=json.loads(json.dumps(result, indent=4)), media_type="application/json")
