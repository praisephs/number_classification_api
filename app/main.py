...
def get_properties(n: float):
    ...
    if n.is_integer():
        ...
        properties.append("decimal number")
    return properties
...
async def classify_number(number: str = Query(..., description="A number to classify")):
    ...
    result = {
        ...
        "is_prime": is_prime(int(number_float)) if number_float.is_integer() else False,
        "is_perfect": is_perfect(int(number_float)) if number_float.is_integer() else False,
        "properties": get_properties(number_float),
        "digit_sum": sum(int(d) for d in str(abs(int(number_float)))) if number_float.is_integer() else None,
        "fun_fact": get_fun_fact(number_float),
    }
